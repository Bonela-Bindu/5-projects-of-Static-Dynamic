...
import HomeCards from "../HomeSectionCards/HomeCards";
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-lg lg:text-xl opacity-60 pt-1 text-gray-900 ">
                Casual PuffSleeves Solid Women White
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 text-sm font-medium text-indigo-800  hover:text-indigo-400 ">
                    3780 Reviews
                  </p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">5799 Ratings</p>
                </div>
        ...
        {/* Similar Products */}
            <section className="pt-10">
              ...
              <div className="flex flex-wrap space-y-5">
                {mens_kurta.map((item)=><HomeCards product={item}/>)}
              </div>
